...
import {
  Portal
} from "./chunk-NSGP4HA6.js";
import {
  require_react_dom
} from "./chunk-HE4GKDYE.js";
import {
  Ripple
} from "./chunk-2TNML5DS.js";
import {
  ComponentBase,
  DomHandler,
...
var Menu = React8.memo(React8.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React8.useContext(PrimeReactContext);
  var props = MenuBase.getProps(inProps, context);
  var _React$useState = React8.useState(props.id), _React$useState2 = _slicedToArray(_React$useState, 2), idState = _React$useState2[0], setIdState = _React$useState2[1];
  var _React$useState3 = React8.useState(!props.popup), _React$useState4 = _slicedToArray(_React$useState3, 2), visibleState = _React$useState4[0], setVisibleState = _React$useState4[1];
  var _React$useState5 = React8.useState(-1), _React$useState6 = _slicedToArray(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var _React$useState7 = React8.useState(-1), _React$useState8 = _slicedToArray(_React$useState7, 2), selectedOptionIndex = _React$useState8[0], setSelectedOptionIndex = _React$useState8[1];
  var _React$useState9 = React8.useState(false), _React$useState10 = _slicedToArray(_React$useState9, 2), focused = _React$useState10[0], setFocused = _React$useState10[1];
  ...
  var menuRef = React8.useRef(null);
  var listRef = React8.useRef(null);
  ...
  var createSubmenu = function createSubmenu2(submenu, index) {
    ...
    return React8.createElement(React8.Fragment, {
      key
    }, React8.createElement("li", _extends2({}, submenuHeaderProps, {
      key
    }), submenu.label), items);
  };
  var createSeparator = function createSeparator2(item, index) {
    ...
    return React8.createElement("li", _extends2({}, separatorProps, {
      key
    }));
  };
  var createMenuItem = function createMenuItem2(item, index) {
    ...
    var icon = IconUtils.getJSXIcon(item.icon, _objectSpread2({}, iconProps), {
      props
    });
    ...
    var content2 = React8.createElement("div", contentProps, React8.createElement("a", actionProps, icon, label, React8.createElement(Ripple, null)));
    if (item.template) {
    ...
    return React8.createElement("li", _extends2({}, menuitemProps, {
      key
    }), content2);
  };
  ...
  var createElement3 = function createElement4() {
    if (props.model) {
      ...
      return React8.createElement(CSSTransition2, _extends2({
        nodeRef: menuRef
      }, transitionProps), React8.createElement("div", _extends2({
        id: props.id,
        ref: menuRef
      }, rootProps), React8.createElement("ul", menuProps, menuitems)));
    }
    return null;
  };
  var element = createElement3();
  return props.popup ? React8.createElement(Portal, {
    element,
